...
assignment_user1 = createUser("Tester","One","testerone@email.edu",50)
assignment_user1.display_info()
assignment_user1.enroll()

assignment_user2 = createUser("Nottester","Two","notatest@email.edu",40)
# assignment_user2.display_info() 
assignment_user3 = createUser("Yepitsatest","Three","jkistest@email.edu",30)
